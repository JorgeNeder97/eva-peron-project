...
import { styles } from './Art30-Styles';

export const Art30 = ({ nombre, cargo, dia, mes, año, fechaCompleta }) => {
    return (
        <Document>
            <Page style={styles.page}>
                ...
                <View style={styles.articulo}>
                    <Text style={styles.primeraLinea}>SOLICITO JUSTIFICACIÓN DE INASISTENCIA POR ARTÍCULO N° 30, INCURRIDO EL DÍA</Text><Text style={styles.dia}>{dia}</Text><Text>DEL MES DE</Text><Text style={styles.mes}>{mes}</Text><Text>DEL AÑO</Text><Text style={styles.año}>{año}</Text>
