...
import styles from './TablaModificarCargos.module.css'
...
export const TablaModificarCargos = ({ cargos, accion, url }) => {
        ...
        <TableBody>
          {cargos.map((cargo) => (
            <StyledTableRow key={cargo.nombre}>
              ...
              <StyledTableCell align="center"><Link to={url + cargo.id} className={styles.iconoEditar}><i className="fa-solid fa-pen-to-square fa-xl"></i></Link></StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
