...
export const registerRequest = async (usuario) => {
    return await axios.post('/api/usuarios/register', usuario, {
        headers: {
...
export const deleteRequest = async (data) => {
    return await axios.delete(`/api/usuarios/deleteUser/${data.id}`); 
}